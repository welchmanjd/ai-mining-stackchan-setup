...
internal static partial class StepMessages
{
    ...
    public const string ApiPrecheckInProgress = "事前確認中...";
    public const string ApiPrecheckSuccess = "事前確認に成功";
    public const string ApiPrecheckSkippedUsingStoredKey = "M5StackCore2保存済みキーを再利用するため確認をスキップ";
    ...
    public const string PostRebootLogCaptureProgressFormat = "60秒ログを取得します... ({0}秒)";
